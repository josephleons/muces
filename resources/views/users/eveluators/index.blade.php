...
<div class="row align-items-center ml-5">
    ...
    <div class="col">
        <span class="textColor">
            <a class="nav-link text-muted fs-5 " href="{{ url('#') }}">Student:Task List</a>
        </span>
    </div>
                                            ...
                                            <span>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="#adduser" type="button" data-toggle="modal" data-target="#exampleModal" ><i class="bi bi-check2-circle text-muted fs-6 m-3"></i>View Task</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="#addusers" type="button" data-toggle="modal" data-target="#exampleModal02"><i class="bi bi-check2-circle text-muted fs-6 m-3"></i>New Progress</a>
                                                        </li>
                                                        <li>
