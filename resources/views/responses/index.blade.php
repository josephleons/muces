                        ...
                        <div class="col-md-12 col-sm-6 col-xm-12 ">
                            <table id="example" class="display table table-bordered" style="width:100%">
                                <thead class="table-muted">
                                    <tr class="text-muted text-capitalize" style="text-transform: capitalize;font-size:14px;">
                                        <th>S/N</th>
                                        <th>Question</th>
                                        <th>Response</th>
                                        <th>Due Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#response{{$evaluation->id}}">view response</button>
                                        </td>
                                            ...
                                            <span>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{'/evaluators/index'.$evaluation->id}}" type="button" data-toggle="modal" data-target="#exampleModal02" ><i class="bi bi-check2-circle text-muted fs-6 m-3"></i>View Response</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </span>
                                                ...
                                                <div class="modal-body">
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                          ...
                                                          <div class="col-md-8">
                                                           Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur quaerat quidem reprehenderit libero, tenetur inventore corporis autem dolores at laborum error enim eos pariatur excepturi fugit. Officia, placeat. Eligendi, magni?
                                                          </div>
                                                        
                                                          <div class="col-md-2 text-success ">
                                                            <a class="btn btn-info">{{$response->status}}</a>
                                                          </div>
                                                        </div>
                                                        <div class="row"><hr></div>
                                                        @endforeach
